...
CREATE OR REPLACE PACKAGE PKG_PRODUCTOS
    IS
     ...
     PROCEDURE ACTUALIZAR_PRODUCTO(NOMBRE VARCHAR2,IMP_PRODUCTO VARCHAR2,TARIFA_IMP NUMBER,DESC_PRODUCTO FLOAT, PRECIO_UNITARIO FLOAT, CATEGORIA_ID NUMBER,PROVEEDOR NUMBER);
    END;
/
...
CREATE OR REPLACE PACKAGE BODY PKG_PRODUCTOS
    IS
      ...
      END;
        ...
        AS
        BEGIN   
            UPDATE INTO PRODUCTOS (NOMBRE,IMP_PRODUCTO,TARIFA_IMP,DESC_PRODUCTO, PRECIO_UNITARIO, CATEGORIA_ID,PROVEEDOR) VALUES (NOMBRE,IMP_PRODUCTO,TARIFA_IMP,DESC_PRODUCTO, PRECIO_UNITARIO, CATEGORIA_ID,PROVEEDOR);
      END;
...
CREATE OR REPLACE PACKAGE PKG_PERSONAS
    IS
     ...
     PROCEDURE ACTUALIZAR_PERSONAS(CEDULA NUMERIC,NOMBRE VARCHAR2,APELLIDOS VARCHAR2,TELEFONO NUMERIC,CORREO_ELECTRONICO VARCHAR2,DIRECCION VARCHAR2);
    ...
    IS
      ...
      END;
       PROCEDURE ACTUALIZAR_PERSONAS(CEDULA NUMERIC,NOMBRE VARCHAR2,APELLIDOS VARCHAR2,TELEFONO NUMERIC,CORREO_ELECTRONICO VARCHAR2,DIRECCION VARCHAR2)
        AS
        BEGIN   
            UPDATE INTO CLIENTES (CEDULA,NOMBRE,APELLIDOS,TELEFONO,CORREO_ELECTRONICO,DIRECCION) 
		VALUES (CEDULA,NOMBRE,APELLIDOS,TELEFONO,CORREO_ELECTRONICO,DIRECCION);
      END;
